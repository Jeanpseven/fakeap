...
dependencies() {
  command -v php > /dev/null 2>&1 || { echo >&2 "É necessário ter o php instalado. Instale-o. Abortando."; exit 1; }
  command -v dnsmasq > /dev/null 2>&1 || { echo >&2 "É necessário ter o dnsmasq instalado. Instale-o. Abortando."; exit 1; }
  command -v hostapd > /dev/null 2>&1 || { echo >&2 "É necessário ter o hostapd instalado. Instale-o. Abortando."; exit 1; }
}
...
createpage() {
  ...
  # Restante do createpage omitido por brevidade...
}
...
stop() {
  printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Finalizando todas as conexões..\n" 
  killall dnsmasq hostapd > /dev/null 2>&1
  sleep 4
  printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Reiniciando serviço de rede..\n" 
...
start() {
  ...
  createpage
  printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Finalizando todas as conexões..\e[0m\n" 
  sleep 2
  ...
  sleep 4
  printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Configurando %s para o modo de monitoramento\n" "$choosed_interface"
  iwconfig "$choosed_interface" mode monitor
  sleep 4
  printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] %s Ativada\n" "$choosed_interface"
  ifconfig wlan0 up
  sleep 5
